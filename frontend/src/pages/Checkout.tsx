...
const plans = [
  { id: 1, name: 'Starter', price: 200, balance: 5000 },
  { id: 2, name: 'Pro', price: 500, balance: 15000 },
  { id: 3, name: 'Elite', price: 1000, balance: 50000 },
];
          ...
          <div className="glass rounded-2xl p-6">
            ...
            <div className="p-4 rounded-xl bg-card/50 border border-border/50 mb-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="font-mono font-bold text-foreground">{plan.price} DH</span>
              </div>
              <div className="space-y-2 text-sm text-muted-foreground">
                <div className="flex justify-between">
                  <span>Solde virtuel</span>
                  <span className="font-mono">${plan.balance.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="border-t border-border pt-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="font-mono text-foreground">{plan.price} DH</span>
              </div>
              <div className="flex items-center justify-between text-lg font-bold">
                <span className="text-foreground">Total</span>
                <span className="font-mono text-primary">{plan.price} DH</span>
              </div>
            </div>
